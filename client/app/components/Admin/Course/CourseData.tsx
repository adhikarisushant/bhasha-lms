...
const CourseData: FC<Props> = ({
    ...
    return (
        <div className='w-[80%] m-auto mt-24 block'>
            <div>
                <label className={`${styles.label} text-[20px]`} htmlFor="email">What are the benefits for students in this course?</label>
                <br />
                ...
                <AddCircleIcon
                    style={{ margin: "10px 0px", cursor: "pointer", width: "30px", color: "#fff" }}
                    onClick={handleAddBenefits}
                />
            </div>

            <div>
                <label className={`${styles.label} text-[20px]`} htmlFor="email">What are the prerequisites for students in this course?</label>
                <br />
