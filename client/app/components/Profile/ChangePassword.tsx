...
const ChangePassword: FC<Props> = (props) => {
    ...
    return (
        <div className='w-full pl-7 px-2 800px:px-5 800px:pl-0'>
            <h1 className='block text-[25px] 800px:text-[30px] font-Poppins text-center font-[500] dark:text-[#fff] text-black pb-2'>Change Password</h1>
            <div className='w-full'>
                ...
                >
                    ...
                    <div className='w-[100%] 800px:w-[60%] mt-2'>
                        <label className="block pb-2 dark:text-[#fff] text-black">Enter your confirm password</label>
                        <input
                            type="password"
                            className={`${styles.input} !w-[95%] mb-4 800px:mb-0 dark:text-[#fff] text-black`}
                            required
