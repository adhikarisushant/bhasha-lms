export const styles = {
  ...
  button:
    "flex flex-row justify-center item-center py-3 px-6 rounded-full cursor-pointer bg-[#2190ff] min-h-[45px] w-full text-[16px] text-white font-Poppins font-semibold",
};
